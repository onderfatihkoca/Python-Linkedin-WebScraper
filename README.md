...
Arkadaşımla küçük bir yan proje yapmaya başladığımızda bu sorunun cevabını arıyorduk. Fakat piyasada iyi bir açık kaynaklı Linkedin Webscraping projesi bulamadık.<br><br>

Bulduğumuz projeler ya ücretli, ya eksik ya da eskiydi. İlanlardan detaylı bilgileri almak yerine sadece basit bir şekilde ilan başlık verisini çekmişlerdi. Bizde kendi Linkedin Webscraper’ımızı yapma kararı aldık. Bunun için öncelikle bir plan kurmamız gerekti şimdi size bundan bahsedeceğim.<br><br>
...
Kodun tam versiyonuna ulaşmak için → onderfatihkoca/linkedin.py
...
İletişim Bilgilerim:
Email: onderfatihkoca@gmail.com
Linkedin: Önder Fatih KOCA
GitHub: onderfatihkoca
